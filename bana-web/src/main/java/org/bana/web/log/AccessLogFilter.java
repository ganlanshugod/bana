...
public class AccessLogFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
		...
		LOG.debug("AccessLogFilter.. 执行开始=========== " + request.getRequestURL());
		...
		if (ignoreList != null && !ignoreList.isEmpty()) {
			for (String pattern : ignoreList) {
				if (url.matches(StringUtils.trim(pattern))) {
					...
					LOG.debug("AccessLogFilter.. 执行结束，忽略日志=========== " + request.getRequestURL());
					return;
				}
			}
		}
		...
		try {
			...
			LOG.debug("AccessLogFilter.. 执行结束===========" + request.getRequestURL());
		}
	}
	 ...
	 * @param accessLogDomain
	 */
	private void createEndLog(HttpServletRequest request, StatusExposingServletResponse response,
			AccessLogDomain accessLogDomain) {
		// 结束时间
	 ...
	 * @param accessLogDomain
	 */
	private void createBeginLog(HttpServletRequest request, StatusExposingServletResponse response,
			AccessLogDomain accessLogDomain) {
		// 设置开始时间
