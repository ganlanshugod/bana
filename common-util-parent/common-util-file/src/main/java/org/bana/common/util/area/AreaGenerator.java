...
/**
 * 全国省市区编码的统一获取，数据来源使用 http://www.stats.gov.cn 网站的数据
 * 
 * @author Liu Wenjie
 *
 */
public class AreaGenerator {
	...
	public static void generatorSqlFromJsonFile(String rootId, String sqlFilePath, String jsonFilePath)
			throws IOException {
	...
	public static void generatorJsonFile(String parentUrl, String filePath) {
		...
		try {
			...
			LOG.debug("保存文件成功===" + file.getAbsolutePath());
		} catch (IOException e) {
			e.printStackTrace();
			LOG.error("保存文件失败", e);
		}
