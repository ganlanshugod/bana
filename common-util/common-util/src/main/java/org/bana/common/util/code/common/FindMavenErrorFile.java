/**
 * @Company 青鸟软通   
 * @Title: FindMavenErrorFile.java 
 * @Package org.bana.common.util.code.common 
 * @author Liu Wenjie   
 * @date 2015-3-10 下午1:20:03 
 * @version V1.0   
 */
package org.bana.common.util.code.common;
...
/**
 * @ClassName: FindMavenErrorFile
 * @Description: 找出maven下载出错的文件
 * 
 */
public class FindMavenErrorFile {
	...
	public static final void handle(File file) {
		...
		if (filename.endsWith(".sha1")) {
			...
			if (!sha1Real.equalsIgnoreCase(sha1Check)) {
				System.out.println(sourcefile.getAbsolutePath() + "的实际SHA1:"
						+ sha1Real);
				System.out.println(file.getAbsolutePath() + "的验证SHA1:"
						+ sha1Check);
			}
		}
	}
	...
	public static void main(String[] args) {
		showAllFiles(new File("D:/Users/repository"));
